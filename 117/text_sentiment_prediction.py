...
def predict(text):
    predicted_emotions=""
    predicted_emotions_img_url=""
    if(text!=""):
        sentence=[]
        sentence.append(text)
        senquences=tokenizer.texts_to_sequences(sentence)
        padded=pad_sequences(senquences,maxlen=max_length,
        ...
        for key,value in emo_code_url.items():
            if(value[0]==predicted_class_label):
                ...
                predicted_emotions=key
        return predicted_emotions,predicted_emotions_img_url
